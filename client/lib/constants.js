...
export const SERVICES_MENU = [
  {
    ...
    image: "/images/services/graphics.png",
    bg: "bg-[#ECFBA9]",
  ...
  },
  {
    ...
    bg: "bg-[#f7f8f4]",
    image: "/images/services/branding.avif",
  ...
  },
  {
    ...
    desc: "Paid media, attribution, and conversion-focused campaigns that turn traffic into pipeline and revenue.",
    bg: "bg-[#F9F871]",
    image: "/images/services/uiux.avif",
    icon: "https://cdn.lordicon.com/lhjwpfnn.json",
    tags: [
  ...
  },
  {
    ...
    bg: "bg-[#67E5C9]",
    image: "/images/services/website.avif",
  ...
  },
  {
    ...
    bg: "bg-[#F9BA71]",
    image: "/images/services/presentation.png",
...
export const PRICING_PLANS = [
  {
    ...
    features: [
      ...
      "Up to 10 pages with custom UI/UX design",
      "Responsive & mobile-first development",
      "CMS integration (Strapi / Sanity / Headless CMS)",
      "SEO foundation (sitemap, meta, performance basics)",
      "3 revision rounds",
  ...
  },
  {
    ...
    features: [
      "Full Brand Identity",
      "Unlimited pages + custom web modules",
      "Full design system & reusable component library",
      "Advanced CMS + e-commerce capability",
